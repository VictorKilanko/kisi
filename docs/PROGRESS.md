...
| Item | State |
|---|---|
| Current phase | **All three sites LIVE (2026-08-20).** pnpm+turbo **monorepo**: **www.kisi.africa** (`apps/africa`, entertainment, repositioned as the universe front door, no commerce), **farm.kisi.africa** (`apps/farm`, the business), **kids.kisi.africa** (`apps/kids`, scaffold), cast in `packages/canon`, tokens in `packages/brand`. **Mascot renamed Taco -> Dede (he/him).** See `docs/SPLIT_PLAN.md` (live checklist) + `docs/MONOREPO.md` (Vercel guide). |
